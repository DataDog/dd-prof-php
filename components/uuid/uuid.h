 ...
 */
void datadog_php_uuidv4_bytes_ctor(datadog_php_uuid *uuid,
                                   const uint8_t src[C_STATIC(16)]);
...
inline bool datadog_php_uuid_is_nil(datadog_php_uuid uuid) {
  ...
  return uuid.data[0] == 0 && uuid.data[1] == 0 && uuid.data[2] == 0 &&
      uuid.data[3] == 0 && uuid.data[4] == 0 && uuid.data[5] == 0 &&
      uuid.data[6] == 0 && uuid.data[7] == 0 && uuid.data[8] == 0 &&
      uuid.data[9] == 0 && uuid.data[10] == 0 && uuid.data[11] == 0 &&
      uuid.data[12] == 0 && uuid.data[13] == 0 && uuid.data[14] == 0 &&
      uuid.data[15] == 0;
}
